  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#0a0b10] text-[#EDE3CC]">
        <p className="font-serif">Opening the vault...</p>
      </div>
    );
  }
    ...
    >
      ...
      <main className="relative max-w-3xl mx-auto px-6 py-14 flex flex-col items-center gap-10">
        <div className="relative text-center">
          <svg className="absolute -top-6 left-1/2 -translate-x-1/2 w-64 h-24 opacity-40" viewBox="0 0 240 90" fill="none">
          ...
          <p className="relative font-mono text-xs text-[#C9A45C] tracking-[0.25em] mb-3">FOR YOUR FUTURE SELF</p>
        ...
        <div className="w-full">
          <p className="text-center font-mono text-xs text-[#7A7D87] tracking-[0.25em] mb-5">— ARCHIVE —</p>
          <div
            className="rounded-2xl p-5 border border-[#4A3A22]"
            style={{ background: "linear-gradient(180deg, #1c150c 0%, #120d07 100%)", boxShadow: "inset 0 0 0 1px rgba(201,164,92,0.15)" }}
          >
